...
const routes = [
  {
    ...
    children: [...dashboardRoutes, ...chartsRoute, ...materialRoutes, ...employeeRoutes, ...customerRoutes, ...productRoutes, ...serviceRoutes, ...iplDashboardRoutes, ...bidHistoryRoutes, ...aggregateRoutes],
  },
  ...sessionRoutes,
